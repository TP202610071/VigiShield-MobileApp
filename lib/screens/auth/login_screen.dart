...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    if (success) {
      // Cierra el contexto de autocompletado: es lo que hace que iOS ofrezca
      // "Guardar en Contrasenas" y Android proponga guardarla. Sin esta
      // llamada el sistema no se entera de que el inicio de sesion fue bueno.
              ...
              if (!sent) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(12),
                    border: Border.all(
                      color: AppColors.safeGreen.withAlpha(77),
                    ),
                  ),
                  child: Row(
                    children: [
